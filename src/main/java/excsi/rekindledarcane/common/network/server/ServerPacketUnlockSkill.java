...
public class ServerPacketUnlockSkill implements IMessage, IMessageHandler<ServerPacketUnlockSkill,IMessage> {

    public String categoryID, skillID;

    public ServerPacketUnlockSkill() {}

    public ServerPacketUnlockSkill(ISkillCategory skillCategory, ISkill skill) {
